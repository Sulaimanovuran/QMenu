...
async def list_categories(branch_id: int, _=Depends(MANAGE)):
...
@menuRouter.patch(
    "/branches/{branch_id}/categories/{category_id}", response_model=GetCategory
)
...
async def list_items(branch_id: int, _=Depends(MANAGE)):
